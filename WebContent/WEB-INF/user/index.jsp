...
<div class="container index">
		    <div  class="span24" style="height: 456px;">
			    	...
			    	<img id="lb1"   src="${pageContext.request.contextPath}/image/dog2.JPG" style="display: block;" width="950" height="456"/>
			    	<img id="lb2"   src="${pageContext.request.contextPath}/image/dog3.JPG" style="display: none;" width="950" height="456"/>
			    	<img id="lb3"   src="${pageContext.request.contextPath}/image/small2.JPG" style="display: none;" width="950" height="456"/>
		    </div>
<!--  	<div class="span24">
